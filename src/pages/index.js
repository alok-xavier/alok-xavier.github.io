          ...
          <div
            ...
            <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap'}}>
              <div>
                ...
                <p style={{color: 'var(--ifm-color-emphasis-700)', marginBottom: '1rem'}}>Tata Consultancy Services</p>
              </div>
              <p style={{color: 'var(--ifm-color-emphasis-700)', fontStyle: 'italic'}}>Aug 2021 - Present</p>
            </div>
        ...
        <div
          ...
          {skills.map((skill, idx) => (
            <div
              ...
              <h3 style={{marginBottom: '1rem', fontSize: '1.1rem', color: 'var(--ifm-color-primary)'}}>{skill.category}</h3>
              <ul style={{listStyle: 'none', padding: 0, margin: 0}}>
                {skill.items.map((item, i) => (
                  <li key={i} style={{padding: '0.4rem 0', fontSize: '0.95rem'}}>
                    <span style={{color: 'var(--ifm-color-primary)', marginRight: '0.5rem'}}>✓</span>
                    {item}
                  </li>
                ))}
              </ul>
      ...
      <div className="container">
        ...
        <div style={{maxWidth: '900px', margin: '0 auto'}}>
          <div
            ...
            <p style={{marginBottom: '1.5rem', opacity: 0.9}}>End-to-end GitOps implementation with AWS EKS, Terraform, and ArgoCD</p>
            <div style={{display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1.5rem'}}>
              <span style={{padding: '0.3rem 0.8rem', background: 'rgba(255,255,255,0.2)', borderRadius: '20px', fontSize: '0.85rem'}}>AWS EKS</span>
              <span style={{padding: '0.3rem 0.8rem', background: 'rgba(255,255,255,0.2)', borderRadius: '20px', fontSize: '0.85rem'}}>Terraform</span>
              <span style={{padding: '0.3rem 0.8rem', background: 'rgba(255,255,255,0.2)', borderRadius: '20px', fontSize: '0.85rem'}}>Kubernetes</span>
              <span style={{padding: '0.3rem 0.8rem', background: 'rgba(255,255,255,0.2)', borderRadius: '20px', fontSize: '0.85rem'}}>ArgoCD</span>
              <span style={{padding: '0.3rem 0.8rem', background: 'rgba(255,255,255,0.2)', borderRadius: '20px', fontSize: '0.85rem'}}>GitHub Actions</span>
            </div>
  ...
  return (
    <section style={{padding: '4rem 0', backgroundColor: '#1a1a2e', color: 'white', textAlign: 'center'}}>
      <div className="container">
        ...
        <p style={{opacity: 0.8, marginBottom: '2rem'}}>Open to discussing DevOps, cloud infrastructure, and SRE practices</p>
        <div style={{display: 'flex', justifyContent: 'center', gap: '1.5rem', flexWrap: 'wrap'}}>
          <Link className="button button--lg" to="https://github.com/alok-xavier" target="_blank" style={{background: '#333', color: 'white'}}>
            🐙 GitHub
          </Link>
          <Link
          ...
          <Link className="button button--lg" to="mailto:alokx6@gmail.com" style={{background: '#ea4335', color: 'white'}}>
            ✉️ Email
          </Link>
          <a
            className="button button--lg"
...
export default function Home() {
  return (
    <Layout title="Home" description="Alok Xavier - DevOps & SRE Engineer with 4+ years managing enterprise cloud infrastructure">
      <HomepageHeader />
      <main>
        <ExperienceSection />
